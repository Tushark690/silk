...
class _AddBannerState extends State<AddBanner> {
  ...
  chooseImage() async {
    if(kIsWeb){
      // html.File pickedFile  = await ImagePickerWeb.getImage(outputType: ImageType.file);
      // print(pickedFile.relativePath);
      // if (pickedFile != null) {
      //   setState(() {
      //     _image.add(File(pickedFile.relativePath+"//"+pickedFile.name));
      //   });
      //   if (File(pickedFile.relativePath+"//"+pickedFile.name) == null) retrieveLostData();
      // }
    }else {
  ...
  void initState() {
    super.initState();
    imgRef = FirebaseFirestore.instance.collection('banners');
  }
}